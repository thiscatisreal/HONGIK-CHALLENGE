   ...
   <body class="main-layout">
                  ...
                  <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col logo_section">
                     <div class="full">
                        <div class="center-desk">
                           <div class="logo">
                              <a href="homepage.php"><img src="images/Logo_of_hongik_university.png" width="100" height="100" alt="#"  /></a>
                           </div>
                        </div>
                     </div>
                  </div>
      ...
      <section class="banner_main">
         ...
         <div class="row d_flex">
            ...
            <div class="col-md-6">
                     <form method = "POST" action = "login.php" id="request" class="main_form">
                        <div class="row">
                           <div class="col-md-12 ">
                              <input name = "id" type="text" class="contactus" placeholder="Student ID" id="id"> 
                           </div>
                           <div class="col-md-12">
                              <input name = "password" type="password" class="contactus" placeholder="Password" id="password">
                           <div class="col-sm-12">
                              <button type = "submit" id="login" class="send_btn">Login</button>
